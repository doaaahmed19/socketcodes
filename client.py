...
buttons[1].place(x=x1,y=y1,width=50,height=20)
buttons[0].config(bg="#d12044")
buttons[1].config(bg="#d12044")

value1=tkinter.StringVar()
score1=tkinter.Label(textvariable=value1, fg="#d12e44")
score1.pack()
score1.place(x=20,y=200)
value1.set(count1)

value2=tkinter.StringVar()
score2=tkinter.Label(textvariable=value2, fg="#d12e44")
score2.pack()
...
def pressE():
    ...
    while True:
        ...
        fireballs1.append(tkinter.Button(root))
        fireballs1[b1].pack()
...
_thread.start_new_thread(pressZ,())  
_thread.start_new_thread(pressX,())  
_thread.start_new_thread(pressC,())       
